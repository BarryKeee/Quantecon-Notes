...
options_ = [];
M_.fname = 'permanent_increase_tau_c';
...
diary off;
diary('permanent_increase_tau_c.log');
M_.exo_names = 'taui';
...
erase_compiled_function('permanent_increase_tau_c_static');
erase_compiled_function('permanent_increase_tau_c_dynamic');
M_.orig_eq_nbr = 2;
M_.eq_nbr = 2;
M_.ramsey_eq_nbr = 0;
...
title('r/q')
save('permanent_increase_tau_c_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('permanent_increase_tau_c_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('permanent_increase_tau_c_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('permanent_increase_tau_c_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('permanent_increase_tau_c_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('permanent_increase_tau_c_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('permanent_increase_tau_c_results.mat', 'oo_recursive_', '-append');
end
