...
diary off;
diary('permanent_increase_g.log');
M_.exo_names = 'taui';
...
erase_compiled_function('permanent_increase_g_static');
erase_compiled_function('permanent_increase_g_dynamic');
M_.orig_eq_nbr = 2;
M_.eq_nbr = 2;
M_.ramsey_eq_nbr = 0;
...
struct('exo_det',0,'exo_id',4,'multiplicative',0,'periods',1:9,'value',0.2) ];
M_.exo_det_length = 0;
...
title('r/q')
save('permanent_increase_g_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('permanent_increase_g_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('permanent_increase_g_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('permanent_increase_g_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('permanent_increase_g_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('permanent_increase_g_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('permanent_increase_g_results.mat', 'oo_recursive_', '-append');
end
